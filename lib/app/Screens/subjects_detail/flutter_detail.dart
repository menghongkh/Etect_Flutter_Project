...
class Flutter_detail extends StatefulWidget {
  const Flutter_detail({Key? key}) : super(key: key);

  @override
  State<Flutter_detail> createState() => _Flutter_detailState();
}

class _Flutter_detailState extends State<Flutter_detail> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: true,
          //title: const Text("Flutter Development",style: TextStyle(fontSize: 23,color: Colors.white,fontWeight: FontWeight.bold),),
          leading: Row(
            children: [
              Padding(
        ...
        body: FutureBuilder<QuerySnapshot>(
            future:
                FirebaseFirestore.instance.collection('flutter_program').get(),
